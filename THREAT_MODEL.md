...
GuardClaw v0.1.4 does NOT guarantee:
...
No external timestamp authority is used in v0.1.4.
...
**Reason:**  
v0.1.4 does not implement hash chaining or Merkle-based continuity proofs.
