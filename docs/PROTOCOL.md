# GuardClaw Protocol Specification (v0.1.3)
...
GuardClaw v0.1.3 does NOT implement:
...
Replay detection in v0.1.3 is nonce-based.
...
File deletion is not detectable in v0.1.3.
